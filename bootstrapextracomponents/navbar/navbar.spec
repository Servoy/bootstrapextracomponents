{
	...
	"model":
	{
		...
		"menuItems" 							: {"type": "menuItem[]", "pushToServer": "shallow","tags": { "doc" :"The array holding all menu items currently shown. Menu items can be specified either by menuItems or servoyMenu property."}},
	...
	"types":
	{
		"menuItem": {
			...
			"displayType"						: {"type": "string", "default": "MENU_ITEM", "values": ["MENU_ITEM", "TEXT", "BUTTON", "INPUT", "INPUT_GROUP", "IMAGE"], "tags": { "doc" :"Controls the appearance of the menu item. One of 'MENU_ITEM', 'TEXT', 'BUTTON', 'INPUT' or 'INPUT_GROUP'."}},
