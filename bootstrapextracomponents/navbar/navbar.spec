{
	...
	"model":
	{
		...
		"menuItems" 							: {"type": "menuItem[]", "pushToServer": "deep","tags": { "doc" :"The array holding all menu items currently shown. Menu items can be specified either by menuItems or servoyMenu property.", "basic": true}},
