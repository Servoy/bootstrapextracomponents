...
- [ ] `npx ng build @servoy/bootstrapextracomponents` compiles without errors
- [ ] `npx ng lint` passes without blocking issues

**Style & conventions**
- [ ] Signal-based inputs/outputs used (not legacy decorators)
- [ ] Component extends `ServoyBaseComponent<HTMLDivElement>` directly
- [ ] Selector uses `bootstrapextracomponents-` prefix
- [ ] No unused imports
...
- [ ] `servoybootstrapextra.module.ts` updated if new declarations
...
- [ ] Signal APIs used correctly (`linkedSignal`, `computed`, `viewChild`, etc.)
