...
- Understand the dual-layer architecture:
  - Servoy spec file (`bootstrapextracomponents/<name>/<name>.spec`) — defines model, handlers, API
  - Angular implementation (`bootstrapextracomponents/projects/bootstrapextracomponents/src/<name>/`)
...
Example: `docs/SVY-21080-navbar-responsive-collapse.spec.md`
...
```
docs/SVY-21080-navbar-responsive-collapse.spec.md
```
